                                    ...
                                    messages=[
                                        {
                                            "role": "user",
                                            "content": [
                                                {"type": "text", "text": f"Describe this image in one sentence(atleast 15 words mandatory). Always start your sentence with 'A photo of {folder.replace('_', ' and ')}' even if you cant assist."},
