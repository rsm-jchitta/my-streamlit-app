        ...
        if training_name:
          ...
          # Replace with your Replicate username
            ...
            def generate_trigger_word(model_name):
                """Generates a unique 4-letter trigger word for the model"""
                hash_val = hashlib.md5(model_name.encode()).hexdigest()[:4]  # First 4 hex chars
                return hash_val.lower()  # Convert to lowercase
